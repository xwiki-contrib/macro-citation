...
public class CitationClassInitializer extends AbstractMandatoryDocumentInitializer
{
    ...
    public boolean updateDocument(XWikiDocument document)
    {
        ...
        needsUpdate |= baseClass.addStaticListField(FIELD_TYPE, FIELDPN_TYPE,
        ...
        if (this.classSheetBinder.getSheets(document).isEmpty()) {
            ...
            DocumentReference sheet =
                new DocumentReference(wikiName, Constants.SPACE, Citation.CLASS + "Class" + "Sheet");
